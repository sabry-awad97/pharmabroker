  ...
  update: protectedProcedure
    ...
    .handler(async ({ input, context }) => {
      ...
      const createData: Prisma.UserAISettingsCreateInput = {
        ...
        idleProcessingEnabled: input.idleProcessingEnabled,
        idleTimeoutSeconds: input.idleTimeoutSeconds,
        idleMaxBatchSize: input.idleMaxBatchSize,
        historyParallelEnabled: input.historyParallelEnabled,
        historyParallelCount: input.historyParallelCount,
        historyProcessDelay: input.historyProcessDelay,
        prioritizeLatest: input.prioritizeLatest,
